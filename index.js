...
var _user$project$Css$centered = _elm_lang$html$Html_Attributes$style(
	{ctor: '[]'});
var _user$project$Css$styleNoOutline = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Css$styleTabSize = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '-moz-tab-size', _1: '4'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'tab-size', _1: '4'},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Css$disabled = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Css$instructionMsgStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Pacifico'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'font-size', _1: '30px'},
			_1: {
...
var _user$project$Css$myStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'bottom'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Css$styleDecimalButton = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Css$orange},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border', _1: 'none'},
			_1: {
...
var _user$project$Css$green = '#4CAF50';
var _user$project$Css$styleCalculateButton = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Css$green},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border', _1: 'none'},
			_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'width', _1: '680px'},
											_1: {
												ctor: '::',
...
var _user$project$Css$blue = '#008CBA';
var _user$project$Css$styleDistanceButtonChosen = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Css$blue},
		_1: _user$project$Css$basicStyleDistanceButton
	});
var _user$project$Css$grey = '#808080';
var _user$project$Css$styleDistanceButton = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Css$grey},
		_1: _user$project$Css$basicStyleDistanceButton
	});
var _user$project$Css$unadjustable = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Models$DecimalLimiterClicked = {ctor: 'DecimalLimiterClicked'};
var _user$project$Models$RoundingButtonClicked = {ctor: 'RoundingButtonClicked'};
var _user$project$Models$CalculateButtonClicked = {ctor: 'CalculateButtonClicked'};
var _user$project$Models$DistanceButtonClicked = function (a) {
	return {ctor: 'DistanceButtonClicked', _0: a};
};
var _user$project$Models$FormatInput = function (a) {
	return {ctor: 'FormatInput', _0: a};
};
...
var _user$project$Models$WarningMsg = function (a) {
	return {ctor: 'WarningMsg', _0: a};
};
var _user$project$Models$ErrorMsg = function (a) {
	return {ctor: 'ErrorMsg', _0: a};
};
var _user$project$Models$Instruction = function (a) {
	return {ctor: 'Instruction', _0: a};
};
var _user$project$Models$Calculated = F2(
	function (a, b) {
		return {ctor: 'Calculated', _0: a, _1: b};
	});
var _user$project$Models$Ready = function (a) {
	return {ctor: 'Ready', _0: a};
};
var _user$project$Models$Blank = {ctor: 'Blank'};
var _user$project$Models$LapSplitTime = {ctor: 'LapSplitTime'};
var _user$project$Models$LapSpeed = {ctor: 'LapSpeed'};
var _user$project$Models$LapTime = {ctor: 'LapTime'};
var _user$project$Models$LapDifference = {ctor: 'LapDifference'};
var _user$project$Models$LapDistance = {ctor: 'LapDistance'};
...
var _user$project$Main$model = {
	textContent: _user$project$Test$testData10k,
	splitTimes: {ctor: '[]'},
