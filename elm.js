...
var _user$project$Utils$TwoDecimal = {ctor: 'TwoDecimal'};
var _user$project$Utils$OneDecimal = {ctor: 'OneDecimal'};

var _user$project$Models$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {textContent: a, distanceChosen: b, splitTimes: c, lapTimes: d, lapTimesFloats: e, infoMsg: f, rounding: g};
	});
...
var _user$project$SpeedSkating$fixDecimalLength = F2(
...
var _user$project$SpeedSkating$differenceToString = F2(
	function (model, x) {
		var number = A2(_user$project$SpeedSkating$fixDecimalLength, model.rounding, x);
...
var _user$project$SpeedSkating$getLapTimesDifferences = F2(
	function (model, lapTimes) {
		var avgLapTime = _user$project$SpeedSkating$getAvgLapTime(lapTimes);
		return A2(
			_elm_lang$core$List$map,
...
var _user$project$SpeedSkating$getLapTimesAsList = F3(
	function (model, lapTimesFloats, firstSplitTime) {
		var lapTimesStrings = A2(
			_elm_lang$core$List$map,
			_user$project$SpeedSkating$fixDecimalLength(model.rounding),
			lapTimesFloats);
		var lapTimesAndDifferences = A4(
			_user$project$Utils$map2Full,
			F2(
				function (x, y) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
			...
			lapTimesStrings,
			A2(_user$project$SpeedSkating$getLapTimesDifferences, model, lapTimesFloats));
...
var _user$project$SpeedSkating$checkValidMinSec = function (splitTimes) {
	return A3(_user$project$SpeedSkating$checkTimesGeneral, _user$project$SpeedSkating$validMinSec, 'Ugyldig tid. Minutter eller sekunder er over 60. Linje : ', splitTimes);
};
							...
							_0: A2(
								_elm_lang$html$Html$textarea,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Models$Input),
											_1: {ctor: '[]'}
										}
									}
								},
									...
									_elm_lang$html$Html$textarea,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder(lapText),
													_1: {ctor: '[]'}
												}
											}
										}
										...
										_elm_lang$html$Html$textarea,
										{
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder(_user$project$Test$testData10k),
														_1: {ctor: '[]'}
													}
												}
											}
				...
				case 'CalculateButtonClicked':
					...
					if (_p6.ctor === '[]') {
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								infoMsg: A2(
									_elm_lang$core$Basics_ops['++'],
									'Kan ikke regne ut : ',
									A3(_user$project$Utils$replaceRegexWith, 'Kan ikke regne ut : ', '', model.infoMsg))
							});
					} else {
						var res = A2(
							_elm_lang$core$Result$andThen,
						...
						if (_p10.ctor === 'Err') {
							...
							return _elm_lang$core$Native_Utils.update(
								model,
								{lapTimes: lapTimesString, lapTimesFloats: lapTimesFloats, infoMsg: 'REGNET UT'});
						}
					}
				default:
...
var _user$project$Main$model = {
	...
	lapTimes: {ctor: '[]'},
	lapTimesFloats: {ctor: '[]'},
	rounding: _user$project$Utils$OneDecimal
};
